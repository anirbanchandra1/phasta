...
! ---------------------------------------------------------------	
!	  vi(:,1) = c1 * (vi_magMOD * nv0(:,1)) + u1(:,1)
!	  vi(:,2) = c1 * (vi_magMOD * nv0(:,2)) + u1(:,2)
!	  vi(:,3) = c1 * (vi_magMOD * nv0(:,3)) + u1(:,3)

	  vi(:,1) = c1*vi_magMOD * nv0(:,1)
	  vi(:,2) = c1*vi_magMOD * nv0(:,2)
	  vi(:,3) = c1*vi_magMOD * nv0(:,3)
	return
