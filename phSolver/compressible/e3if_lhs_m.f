...
c
!------------------------ SPLITTING calc_egmass subroutines ------------------

!----------------------------EGMASS00-----------------------------------------

      subroutine calc_egmass00(
     &                        egmass
     &,                       shp0, shp1, shg0, shg1
     &,                       Ai1
     &,                       Kij0, Kij1
...
c
        integer :: i,j,i0,j0,il,jl,iflow,jflow,kflow,isd,jsd,ishl0
        real*8 :: this_mu(npro,nflow,nflow)
        real*8, dimension(npro) :: Ai1Na1ni0,Kij1Naj1ni0,Kij0Nbj0CNa1ni1,CNb0ni0CNa1ni1
	real*8, dimension(npro,nflow,nflow) :: LC
         real*8, dimension(npro,nshl0) :: modshg   
...
!------------y*n----------------
        ...
        do ishl0 =1,nshl0
         do jsd=1,nsd
           modshg(:,ishl0)=modshg(:,ishl0)+shg0(:,ishl0,jsd)*nv0(:,jsd)
         enddo
        enddo
        !--------------LC--------------
        do iflow =1,nflow
...
c
        ...
        enddo
c
      end subroutine calc_egmass00
!--------------------------------EGMASS01------------------------------------------------------
	 subroutine calc_egmass01(
     &                        egmass
     &,                       shp0, shp1, shg0, shg1
     &,                       Ai1
     &,                       Kij0, Kij1
...
c
        ...
        enddo
c
      end subroutine calc_egmass01
!---------------------------------EGMASS10----------------------------------------------
 	subroutine calc_egmass10(
     &                        egmass
     &,                       shp0, shp1, shg0, shg1
     &,                       Ai1
     &,                       Kij0, Kij1
...
!------------y*n----------------
        ...
        do ishl0 =1,nshl0
         do jsd=1,nsd
           modshg(:,ishl0)=modshg(:,ishl0)+shg1(:,ishl0,jsd)*nv0(:,jsd)
         enddo
        enddo
        !--------------LC--------------
        do iflow =1,nflow
...
c
        ...
        enddo
c
      end subroutine calc_egmass10
!--------------------------------------------EGMASS11------------------------------------
	 subroutine calc_egmass11(
     &                        egmass
     &,                       shp0, shp1, shg0, shg1
     &,                       Ai1
     &,                       Kij0, Kij1
